...
def main():
    ...
    **2. Allocate Your Points**
    ...
    strengths while providing an honest reflection of your experience in other areas. **You can enter in a number between 1 and 10 or you could use the arrows to increase or decrease the number. **
